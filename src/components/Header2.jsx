  ...
  return (
    <>
      <div className="font-sans min-h-screen bg-gradient-to-b from-pink-50 to-white">
        ...
        {/* Benefits Section */}
        <section id="benefits" className="py-20 px-4 bg-pink-50">
          <div className="container mx-auto">
            <h2 className="text-3xl md:text-4xl font-bold text-center text-gray-900 mb-12">
        ...
        <section id="testimonials" className="py-20 px-4 bg-pink-50">
          <div className="container mx-auto">
            <h2 className="text-3xl md:text-4xl font-bold text-center text-gray-900 mb-12">
              Historias de éxito
            </h2>
        ...
        {/* Final CTA Section */}
        <section className="py-20 px-4 bg-gradient-to-r from-pink-300 to-pink-200">
